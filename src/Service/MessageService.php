...
use Zone\Wildduck\Dto\Message\SubmitDraftMessageResponseDto;
use Zone\Wildduck\Dto\Message\UpdateOutboundMessageRequestDto;
use Zone\Wildduck\Dto\Message\UpdateOutboundMessageResponseDto;
...
class MessageService extends AbstractService
{
     ...
     * @throws ValidationException
     */
    public function updateOutbound(string $user, string $queueId, UpdateOutboundMessageRequestDto $params, array|null $opts = null): UpdateOutboundMessageResponseDto
    {
        return $this->requestDto(
            'put',
            $this->buildPath('/users/%s/outbound/%s', $user, $queueId),
            $params,
            UpdateOutboundMessageResponseDto::class,
            $opts
        );
    }
     ...
     * @param int $message
     * @param array<string, mixed>|null $opts
     * @return SubmitDraftMessageResponseDto
     * @throws ApiConnectionException
     * @throws AuthenticationFailedException
     * @throws InvalidAccessTokenException
     * @throws RequestFailedException
     * @throws ValidationException
     */
    public function submitDraft(string $user, string $mailbox, int $message, SubmitDraftMessageRequestDto $params, array|null $opts = null): SubmitDraftMessageResponseDto
    {
        return $this->requestDto(
            'post',
            $this->buildPath('/users/%s/mailboxes/%s/messages/%s/submit', $user, $mailbox, $message),
            $params,
            SubmitDraftMessageResponseDto::class,
            $opts
        );
    }
